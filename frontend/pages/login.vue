      ...
      <form @submit.prevent="submitLogin" class="">
        <div class="flex flex-col">
          <input
            ...
            class="w-full border rounded-t border-slate-300 focus:border-slate-400 focus:ring-2 focus:ring-opacity-50 focus:ring-slate-400 placeholder-slate-400 text-slate-900" />
          <input
            type="password"
            id="password"
            name="password"
            ...
            class="w-full border rounded-b border-slate-300 focus:border-slate-400 focus:ring-2 focus:ring-opacity-50 focus:ring-slate-400 placeholder-slate-400 text-slate-900" />
        </div>
